...
namespace SwagOverflow.WPF.Collections
{
  ...
  public class PeHeaderReader {
    ...
    /// <summary>
    /// Gets the header of the .NET assembly that holds PeHeaderReader
    /// </summary>
    /// <returns></returns>
    ...
    /// </summary>
    /// <returns></returns>
    public static PeHeaderReader GetAssemblyHeader(Type type) {
      // Get the path to the calling assembly, which is the path to the
      // DLL or EXE that we want the time of
      string filePath = System.Reflection.Assembly.GetAssembly(type).Location;
